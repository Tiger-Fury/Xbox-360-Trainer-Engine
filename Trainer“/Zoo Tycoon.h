...
DWORD buf[] = {0x603AF160, 0x00000000};
...
{ 
	...
	if(MYPtr2 == 0x03 && InfHealth == TRUE)
	{
		*(DWORD*)(MYPtr1) = 0x4E6E6B28;
...
VOID SetHooks()
{
	/*addr = GetAddr(0x60000000, 0x70000000, buf, 2, 1)+ 0x14;*/
	Caveme(0x8298c008 ,CheckHealth,16);
	HooksSet = true;
}
