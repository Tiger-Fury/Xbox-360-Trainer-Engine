...
UINT32 g_titleID = 0x584108c3;

DWORD buf[] = {0x39290001, 0x914B0D54};
DWORD Nukebuf[] = {0x39080001, 0x914B0D5C};
DWORD Skillbuf[] = {0x7D4A4A14, 0x914B0D50};
DWORD Grenbuf[] = {0x2B090000, 0x91771A40};


VOID ShowTrainerMain()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3furyGaming.co.uk", L"Assault Heroes 2 + 4\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
