...
VOID SetHooks()
{
	 ...
	 patchInJump( (PDWORD)IHealth, (DWORD)CheckHP, FALSE );
		...
		DoCave(0x83123300, &IHealth[0], 4);
		DoCave(0x83123304, &IHealth[1], 4);
		DoCave(0x83123308, &IHealth[2], 4);
		DoCave(0x8312330C, &IHealth[3], 4);
