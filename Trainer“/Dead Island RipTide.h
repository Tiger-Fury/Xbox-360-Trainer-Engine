...
UINT32 g_titleID = 0x4B4D07F2;

VOID ShowTrainerMain()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3furyGaming.co.uk", L"Dead Island Riptide +10 Trainer\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}
...
VOID SearchAddr()
{
	...
	DWORD buf_Health[] = {0x48000008, 0xD3FF0884};
	DWORD buf1HK[] = {0x419A0008, 0xD3FF05A4};
	DWORD buf_Ammo[] = {0x2B0B0000, 0x90E90000};
	DWORD buf_stam[] = {0xC01E0060, 0xD1BF0914};
	DWORD buf_Cash[] = {0x7CFE5214, 0x911F0744};
	DWORD buf_XP[] = {0x2B0A0000, 0x9123003C};
	DWORD buf_Light[] = {0xED8D07FC, 0xD19F0034};
	DWORD buf_Weapon[] = {0xD3FE0004, 0x38210070};
	DWORD buf_Rage[] = {0xD01F1318, 0xFF00F800};
	DWORD buf_Items[] = {0x396BFFFF, 0x7F64DB78};

	addr = GetAddr(0x82000000, 0x83000000, buf_Health, 2, 1) + 0x04;
	addr_1HK = GetAddr(0x82000000, 0x83000000, buf1HK, 2, 1) + 0x04;
	addr_ammo = GetAddr(0x82000000, 0x83000000, buf_Ammo,2,1) + 0x04;
	addr_Stamina = GetAddr(0x82000000, 0x83000000, buf_stam,2,1) + 0x04;
	addr_Cash = GetAddr(0x82000000, 0x83000000, buf_Cash,2,1) + 0x04;
	addr_XP = GetAddr(0x82000000, 0x83000000, buf_XP,2,1) + 0x04;

	addr_Light = GetAddr(0x82000000, 0x83000000, buf_Light,2,1) + 0x04;
	addr_Weapon = GetAddr(0x82900000, 0x83000000, buf_Weapon,2,1);
	addr_Rage = GetAddr(0x82ED6400, 0x83000000, buf_Rage,2,1);
	addr_Items = GetAddr(0x82EB0000, 0x83000000, buf_Items,2,1);
	SetAddr = true;
}