...
DWORD buf[] = {0xEDA0F828, 0xD1BF0040};
DWORD bufAmmo[] = {0x916A0004, 0x897F00A2};
DWORD bufstam[] = {0x9421FF90, 0xC003000C};
DWORD bufstam1[] = {0x81610054, 0x917C68B0};
DWORD bufxp[] = {0x91630004, 0x7CEA4850};
...
VOID SetHooks()
{
	Caveme( 0x822CA294,CheckHealth,15);
	HooksSet = true;
}

VOID ShowTrainerMain()
{
	Prompt = XShowMessageBoxUI(0, L"More at T3furyGaming.co.uk", L"Sniper Elite 3 Ultimate Edition + 7\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
	if( HooksSet == false )
	{
		SetHooks();
	}
...
VOID SearchAddr()
{
	hNotify(L"Sniper Elite 3 Ultimate Edition");
	Sleep(25);
 	addr = GetAddr(0x82000000, 0x83000000, buf, 2, 1);
	addr_ammo = GetAddr(0x826B0000, 0x83000000, bufAmmo, 2, 1);
