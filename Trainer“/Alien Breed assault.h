...
UINT32 g_titleID = 0x58410A22;


DWORD buf[] = {0x419A007C, 0x817F02D8};
DWORD bufAmmo[] = {0x817e0330, 0x815e032c};
DWORD bufItem[] = {0x814B0650, 0x890a0261};
...
{
	Prompt = XShowMessageBoxUI(0, L"More at T3furyGaming.co.uk", L"Alien Breed 2: Assault + 3\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
	if( HooksSet == false )
	{
		SetHooks();
	}
