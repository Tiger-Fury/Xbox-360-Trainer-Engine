...
UINT32 g_titleID = 0x58410B00;

DWORD buf[] = {0xD023002C, 0x4E800020};//
DWORD Timerbuf[] = {0x556B003E, 0x9143001C};//
DWORD xpbuf[] = {0x7D4AF214, 0x917F0024};//
DWORD ammobuf[] = {0xC00A72B0, 0xD1BF01B4};
DWORD weabuf[] = {0xD3FF00FC, 0x2B050000};//
...
{
	Prompt = XShowMessageBoxUI(0, L"More at T3furyGaming.co.uk", L"Dead Rising 2 CW + 6\r\n~~~~~~~~~~~~~~~~~~~~~~~~~\r\nView Available Codes: DPAD-DOWN(x4)\r\nActivate All Codes: DPAD-UP(x4)\r\n", ARRAYSIZE(g_strButtons), g_strButtons, 0, XMB_PASSCODEMODE, &g_mb_result, &g_xol);
}
...
VOID SearchAddr()
{
	hNotify(L"Dead Rising 2 Case West");
