...
VOID ButPress( MESSAGEBOX_RESULT g_mb_result )
{
   ...
   if( g_mb_result.rgwPasscode[0] == X_BUTTON && g_mb_result.rgwPasscode[1] == X_BUTTON && g_mb_result.rgwPasscode[2] == X_BUTTON && g_mb_result.rgwPasscode[3] == X_BUTTON )
	...
	//	DmSetMemory( (void*)0x826BDBAC, 4 , AmmoMPZM, NULL );
		...
		memcpy( (void*)0x823F9D98, GodMPZM, 4);
	//	DmSetMemory( (void*)0x82190B48, 4 , GodMPZM, NULL );
	//	BYTE KillstreaksActivated[1] = { 0x01 };
	//	memcpy( (void*)0x8354A73C, KillstreaksActivated, 1);
	//	DmSetMemory( (void*)0x8354A73C, 4 , KillstreaksActivated, NULL );
	//	BYTE KillstreaksActivated1[1] = { 0x01 };
	//	memcpy( (void*)0x8354A741, KillstreaksActivated1, 1);
	//	DmSetMemory( (void*)0x8354A741, 4 , KillstreaksActivated1, NULL );
	//	BYTE KillstreaksActivated2[1] = { 0x01 };
	//	memcpy( (void*)0x8354A745, KillstreaksActivated2, 1);
	//	DmSetMemory( (void*)0x8354A745, 4 , KillstreaksActivated2, NULL );
	//	BYTE KillstreaksActivated3[4] = { 0x60 , 0x00 , 0x00 , 0x00 };
	//	memcpy( (void*)0x826BCFB0, KillstreaksActivated3, 4);
	//	DmSetMemory( (void*)0x826BCFB0, 4 , KillstreaksActivated3, NULL );
	//	BYTE BlingBling[4] = { 0x00 , 0x0F , 0xFF , 0xFF  };
